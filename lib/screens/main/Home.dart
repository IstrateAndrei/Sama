...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    _buttonScaleAnimation = Tween(begin: 25.0, end: 150.0).animate(
        CurvedAnimation(
  ...
  Widget getScreen(BuildContext context, double width, double height) {
    ...
    Widget titleImage = AnimatedBuilder(
      ...
      builder: (BuildContext context, _) {
        return Container(
          height: _isFirstRoundFinished ? 150 : _scaleAnimation.value / 3,
          width: _isFirstRoundFinished ? width : _scaleAnimation.value,
    ...
    AnimatedBuilder newGameButton = AnimatedBuilder(
        ...
        builder: (context, _) {
          if (_isFirstRoundFinished) {
            return SizedBox(
              height:
                  _isFirstRoundFinished ? _buttonScaleAnimation.value / 3.5 : 0,
              width:
                  _isFirstRoundFinished ? _buttonScaleAnimation.value * 1.5 : 0,
